...
@app.route('/data/api/yelp_academic_dataset_business.json/limit/<int:n_entries>/', methods=['GET'])
def get_some_data(n_entries):
	with open('data/api/yelp_academic_dataset_business.json') as data_file:
